...
const Detail = (props) => {
  const { requestId, apptype } = props;
  console.log('detail ', apptype, requestId);

  // const requestIdURL = useParams().requestId;
  // const apptypeURL = useParams().apptype;
  // console.log('?', requestIdURL, apptypeURL);
  // if (typeof requestIdURL !== 'undefined') {
  //   requestId = requestIdURL;
  // }
  // if (typeof apptypeURL !== 'undefined') {
  //   apptype = apptypeURL;
  // }
  ...
  useEffect(() => {
    console.log('change ?', requestId, apptype);
  }, [requestId, apptype]);
